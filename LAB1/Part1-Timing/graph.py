...
ax_all.set_xticks(np.arange(0,326,25))

ax_all.hist(l1_all,  label="L1",   bins=np.arange(0, 325 ), alpha=0.5) 
ax_all.hist(l2_all,  label="L2",   bins=np.arange(0, 325 ), alpha=0.5) 
ax_all.hist(l3_all,  label="L3",   bins=np.arange(0, 325 ), alpha=0.5) 
ax_all.hist(mem_all, label="DRAM", bins=np.arange(0, 325 ), alpha=0.5) 
fig_all.legend()
